...
const Testimonials = () => {
        return <>
    <div class="appmixo-position">
        <div id="fullpage">

            <div class="section " id="section0">
               <div class="appmixo-testimonials">
                            ...
                            <div class="col-lg-3 col-12">
                                <div class="client">
                                    <div class="client-close">
                                        <a href="index.html"> <img src="./assets/images/Close.png" alt=""></img></a>
                                    </div>
                                    <div class="client-img text-center">
                                        <img src="./assets/images/client-image.png" alt=""></img>
                                    </div>
                            ...
                            <div class="col-lg-9 col-12 position-relative">
                                <div class="client-testimonial">
                                    <div class="testimonial-left">
                                        <img src="./assets/images/comma-left.png" alt=""></img>
                                    </div>
                                    <div class="testimonial-circle-right">
                                        <img src="./assets/images/right-icon.png" alt=""></img>
                                    </div>
                                    ...
                                    <div class="testimonial-right">
                                        <img src="./assets/images/comma-right.png" alt=""></img>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <img src="./assets/images/down.png" alt=""></img>
                        </div>
